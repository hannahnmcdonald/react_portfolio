          ...
          <div className="row">
            ...
            <div className="col-lg-12 col-md-10 p-4">
              <div className="row text-center align-items-center">
                <div className="col-sm desc">
                  <h4>Check Mate</h4>
                  <p className="desc">CheckMate is an app to keep track of your game nights with friends and family! Check Mate is a full stack application enabling a user to create a profile, add friends, and create friend groups. Users can begin game events and record the results to the participating players' individual stats, stored in a Mongo Database, and shown on their profile, along with some of their favorite games. Users are able to research the stats of their friends and themselves. They can also submit and review alternate game rule sets for specific games also stored in a Mongo database and also are able to access game specific rules.</p>
